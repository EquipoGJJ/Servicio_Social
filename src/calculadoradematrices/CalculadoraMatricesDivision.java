...
public class CalculadoraMatricesDivision extends javax.swing.JFrame {

    public CalculadoraMatricesDivision() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(R11, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 90, 50, 35));
        ...
        jPanel1.add(R12, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 90, 50, 35));
        ...
        jPanel1.add(R13, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 90, 50, 35));
        ...
        jPanel1.add(R21, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 140, 50, 35));
        ...
        jPanel1.add(R22, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, 50, 35));
        ...
        jPanel1.add(R23, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 50, 35));
        ...
        jPanel1.add(R31, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 190, 50, 35));
        ...
        jPanel1.add(R32, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 190, 50, 35));
        ...
        jPanel1.add(R33, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 190, 50, 35));
    ...
    private void MultiplicarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MultiplicarActionPerformed
        ...
        double multia11, multia12, multia13, deterA, r11, r12, r13, r21, r22,
                ...
                multi11, multi12, multi13, multi21, multi22, multi23, multi31, multi32, multi33;
        ...
        //Obtener la Determinante de la matriz B
        ...
        //Obtener la Adjunta de la matriz B
        ...
        //Obtener resultador de la Inversa de la matriz B
        i11 = (1 / deterA) * r11;
        i12 = (1 / deterA) * r12;
        i13 = (1 / deterA) * r13;
        i21 = (1 / deterA) * r21;
        ...
        i32 = (1 / deterA) * r32;
        i33 = (1 / deterA) * r33;
        //Multitplicar valores de la matriz A, por los valores de la inversa de B
        multi11 = (cna11 * i11) + (cna12 * i21) + (cna13 * i31);
        multi12 = (cna11 * i12) + (cna12 * i22) + (cna13 * i32);
        multi13 = (cna11 * i13) + (cna12 * i23) + (cna13 * i33);
        multi21 = (cna21 * i11) + (cna22 * i21) + (cna23 * i31);
        multi22 = (cna21 * i12) + (cna22 * i22) + (cna23 * i32);
        multi23 = (cna21 * i13) + (cna22 * i23) + (cna23 * i33);
        multi31 = (cna31 * i11) + (cna32 * i21) + (cna33 * i31);
        multi32 = (cna31 * i12) + (cna32 * i22) + (cna33 * i32);
        multi33 = (cna31 * i13) + (cna32 * i23) + (cna33 * i33);
        /*//Pasar de String a double
        String r11 = String.valueOf(multi11);
        String r12 = String.valueOf(multi12);
        String r13 = String.valueOf(multi13);
        String r21 = String.valueOf(multi21);
        String r22 = String.valueOf(multi22);
        String r23 = String.valueOf(multi23);
        String r31 = String.valueOf(multi31);
        String r32 = String.valueOf(multi32);
        String r33 = String.valueOf(multi33);*/
        //Asignar valores a la resultante de la suma de A y B
        DecimalFormat limit = new DecimalFormat("###.##");
        R11.setText(limit.format(multi11));
        R12.setText(limit.format(multi12));
        R13.setText(limit.format(multi13));
        R21.setText(limit.format(multi21));
        R22.setText(limit.format(multi22));
        R23.setText(limit.format(multi23));
        R31.setText(limit.format(multi31));
        R32.setText(limit.format(multi32));
        R33.setText(limit.format(multi33));
    ...
    private void VolverElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VolverElegirActionPerformed
        Principal conexion6 = new Principal();
        conexion6.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculadoraMatricesDivision.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculadoraMatricesDivision().setVisible(true);
            }
        });
    }
