...
public class CalculadoraMatricesSuma extends javax.swing.JFrame {

    public CalculadoraMatricesSuma() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(Suma, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 250, 110, -1));
    ...
    private void SumaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SumaActionPerformed
        ...
        double suma11, suma12, suma13, suma21, suma22, suma23, suma31, suma32, suma33;
        ...
        String r11 = String.valueOf(suma11);
        String r12 = String.valueOf(suma12);
        String r13 = String.valueOf(suma13);
        String r21 = String.valueOf(suma21);
        String r22 = String.valueOf(suma22);
        String r23 = String.valueOf(suma23);
        String r31 = String.valueOf(suma31);
        String r32 = String.valueOf(suma32);
        String r33 = String.valueOf(suma33);
    ...
    private void VolverElegirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VolverElegirActionPerformed
        Principal conexion2 = new Principal();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculadoraMatricesSuma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculadoraMatricesSuma().setVisible(true);
            }
        });
    }
